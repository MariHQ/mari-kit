...
python -m pip install 'mari-kit[openai-agents] @ git+https://github.com/MariHQ/mari-kit.git'
python -m pip install 'mari-kit[langchain] @ git+https://github.com/MariHQ/mari-kit.git'
```
