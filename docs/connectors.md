...
from mari_kit.connectors import GitHubConfig, poll_github
...
from mari_kit.connectors.events import verify_slack_signature
...
```python
from mari_kit.connectors import ConnectorMode, connector_definitions
