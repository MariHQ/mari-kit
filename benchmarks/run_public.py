...
from mari_kit.retrieval import BM25Index, DenseFlatIndex, HNSWIndex, IVFPQIndex
...
def environment() -> dict[str, Any]:
    ...
    return {
        ...
        "index_implementation_sha256": digest(
            repository / "src/mari_kit/retrieval/indexes.py", "sha256"
        ),
...
def scifact_retrieval(data_dir: Path) -> tuple[dict[str, Any], list[dict[str, Any]]]:
    ...
    report = {
        ...
        "system": {
            "retriever": "mari_kit.retrieval.BM25Index",
            "k1": 1.2,
            "b": 0.75,
        },
        "metrics": {
